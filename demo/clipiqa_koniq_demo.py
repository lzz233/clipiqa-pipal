...
def parse_args():
    ...
    # parser.add_argument('--file_path', default='C:/Users/22162/Desktop/Postgraduate/Codes_and_Datasets/Datasets/koniq10k/1024x768/', help='path to input image file')
    parser.add_argument('--file_path', default='D:/Datasets/PIPAL/Distortion/Distortion_1/', help='path to input image file')
    parser.add_argument('--csv_path', default='C:/Users/22162/Desktop/Postgraduate/Codes_and_Datasets/Datasets/koniq10k/koniq10k_distributions_sets.csv', help='path to input image file')
...
def main():
    ...
    txt_path = 'D:/Datasets/PIPAL/Distortion/Train_Label/'
    ...
    pred_score = np.squeeze(np.array(pred_score, dtype=object))*100
