...
def parse_args():
    ...
    # parser.add_argument('--file_path', default='C:/Users/22162/Desktop/Postgraduate/Codes_and_Datasets/Datasets/koniq10k/1232.jpg', help='path to input image file')
    parser.add_argument('--file_path', default='D:/Datasets/PIPAL/Distortion/Distortion_1/A0001_00_00.bmp', help='path to input image file')
...
def main():
    ...
    fig.write_image('C:/Users/22162/Desktop/CLIP-IQA-2-3.8/demo/test.svg', engine="kaleido")
